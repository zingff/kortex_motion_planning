...
class KortexMotionWidget
{
  ...
  void plan()
  {
    ...
    target_pose_.position.x = 0.315008;
    target_pose_.position.y = -0.0159545;
    target_pose_.position.z = 0.325314;
    // target_pose_.position.x = x;
    // target_pose_.position.y = y;
    // target_pose_.position.z = z;
    // 0.2497374, 0.8497921, 0.2278447, 0.4044396
    // target_pose_.orientation.x = 0.2497374;
    // target_pose_.orientation.y = 0.8497921;
    // target_pose_.orientation.z = 0.2278447;
    // target_pose_.orientation.w = 0.4044396;
